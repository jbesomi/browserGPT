...
class Crawler:
    ...
    def go_to_page(self, url: str = Field("URL to go")):
    ...
    def click(self, id: str = Field(description="id of the element to click")):
    ...
    def type(
        self,
        id: str = Field(description="id where the text is typed into"),
        text: str = Field(description="text to type into the id"),
    ):
        self.click(id)
